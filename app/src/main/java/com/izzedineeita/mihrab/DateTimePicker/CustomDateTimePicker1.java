package com.izzedineeita.mihrab.DateTimePicker;
...
public class CustomDateTimePicker1 implements View.OnClickListener {
    ...
    public CustomDateTimePicker1(Activity a,
